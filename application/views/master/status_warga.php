    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm ">
                <div class="card-body">
                    <h5>Management Status Warga</h5>
                    <button class="btn btn-sm btn-primary add mb-3"><i class="fa fa-plus"></i> Tambah</button>
                    ...
                    <table class="table table-bordered" id="tableWarga">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-success edit" data-id="<?= $d->id_status ?>" data-status="<?= $d->status_warga ?>"><i class="fa fa-edit"></i></button>
...
<script>
    ...
    $('.add').click(function(){
        ...
        $('#formStatus').attr('action','<?= base_url('master/add_status_warga'); ?>');
        $('.modal-title').html('Tambah Status Warga');
        $('#status').val('');
    });
    ...
    $(document).on('click','.edit', function(){
        ...
        $('#exampleModal').modal('show');
        $('#formStatus').attr('action','<?= base_url('master/edit_status_warga'); ?>');
        $('.modal-title').html('Edit Status Warga');
        $('#status').val(status);
        $('#id_status').val(id);
    });
